            ...
            <Flex justifyContent="space-between" alignItems={['left', 'center']} flexDirection={['column', 'row']}>
              <Label fontSize="14px" lineHeight="20px" fontWeight="400" htmlFor="confirmContribution-processedAt">
                <span>
                  ...
                  <StyledTooltip
                    content={() => (
                      <FormattedMessage defaultMessage="The date funds were cleared on your bank, Wise, PayPal, Stripe, CinetPay or any other external account holding these funds." />
                    )}
                  >
                    <InfoCircle size={16} />
                  </StyledTooltip>
