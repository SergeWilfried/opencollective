...
const featuredHosts = [
  {
    ...
    imageUrl: 'https://images.doohi.org/foundation/a7d522f/logo/256.png',
  },
  {
    id: 'OSC',
    name: 'Code Collective',
    collectivePageLink: '/opensource',
    imageUrl: 'https://images.doohi.org/opensource/426badd/logo/256.png',
  },
  {
    id: 'OCE',
    name: 'Doohi Europe',
    collectivePageLink: '/europe',
    imageUrl: 'https://images.doohi.org/europe/019a512/logo/256.png',
  },
];
      ...
      <Flex mt={4} p={2} backgroundColor="rgba(49, 50, 51, 0.6)" justifyContent="center">
        <Flex alignItems="center" justifyContent={['space-around', null, null, null, 'flex-start']}>
          ...
          <Container display={['block', 'flex']} alignItems={[null, 'center']}>
            ...
            <StyledLink openInNewTab href="https://docs.doohi.com/help/fiscal-hosts/become-a-fiscal-host">
              <StyledButton
                my={2}
                ml={[null, 3]}
