...
const learningChannels = [
  ...
  },
  {
    id: 'openFinances',
    name: 'Open Finances',
    link: 'https://doohi.org/opencollective',
    desktopItemOrder: 5,
  },
  {
    id: 'openCompany',
          ...
          <Box width={['288px', '332px', null, null, '360px']} textAlign={['center', 'left']} mr={[null, 4]}>
            ...
            <P color="black.700" fontSize="18px" lineHeight="27px" letterSpacing="-0.2px" my={3}>
              <FormattedMessage
                ...
                defaultMessage="Doohi is free for charitable initiatives. We rely on generosity of contributors like you to make this possible."
              />
            </P>
          </Box>
