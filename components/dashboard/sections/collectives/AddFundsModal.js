                ...
                <Form data-cy="add-funds-form" className="flex h-full  flex-col overflow-y-hidden">
                  <div className="w-full flex-grow overflow-y-auto pb-4">
                    ...
                    <Field
                      ...
                      inputType="date"
                      hint={
                        <FormattedMessage defaultMessage="The date funds were cleared on your bank, Wise, PayPal, CinetPay, Stripe or any other external account holding these funds." />
                      }
