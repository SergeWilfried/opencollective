...
const messages = defineMessages({
  ...
  'pricing.dashboard.description': {
    ...
    defaultMessage:
      'Easily manage budgets and expenses across all your Collectives, including automated credit card payments through Stripe and one-click payouts via Paypal, Wise, CinetPay or Paystack.',
  },
    ...
    <Card padding={['24px', null, '32px']} width={['288px', '636px']} borderRadius="8px" border="1px solid #DCDEE0">
      ...
      <Flex flexDirection={['column', 'row']} alignItems={['flex-start', 'center']}>
        <Box mr={[null, '33px', '72px']}>
          ...
          <P fontSize="12px" lineHeight="18px" color="black.700">
            ...
            <FormattedMessage
              ...
              defaultMessage="Payment processor fees apply when using <stripeLink></stripeLink>, <paypalLink></paypalLink>, <cinetPayLink></cinetPayLink>, <paystackLink></paystackLink>, or <transferwiseLink></transferwiseLink>."
              values={{
                ...
                cinetPayLink: getI18nLink({
                  href: 'https://cinetpay.com/pricing',
                  openInNewTab: true,
                  children: 'CinetPay',
                }),
        ...
        <ListWrapper as="ul" mt={['16px', 0]}>
          ...
          <ListItem>
            <FormattedMessage defaultMessage="Expense management and one-click payouts via Paypal, Wise, CinetPay or Paystack" />
          </ListItem>
        </ListWrapper>
      </Flex>
