            ...
            {hasManualPayment && (
              <React.Fragment>
                ...
                <StyledInputField
                  ...
                  hint={
                    <FormattedMessage defaultMessage="The date funds were cleared on your bank, Wise, CinetPay, PayPal, Stripe or any other external account holding these funds." />
                  }
                >
                  {inputProps => (
                    <StyledInput
