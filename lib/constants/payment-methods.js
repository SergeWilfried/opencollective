...
export const EXPENSE_PAYMENT_METHOD_SERVICES = [PAYMENT_METHOD_SERVICE.PAYPAL, PAYMENT_METHOD_SERVICE.WISE, PAYMENT_METHOD_SERVICE.BIZAO, PAYMENT_METHOD_SERVICE.PAYSTACK];
...
export const GQLV2_SUPPORTED_PAYMENT_METHOD_TYPES = {
  ...
  MOBILE_MONEY: GQLV2_PAYMENT_METHOD_LEGACY_TYPES.MOBILE_MONEY
};
